...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class PropSniperPro : Strategy
    {
        ...
        protected override void OnBarUpdate()
        {
            ...
            // Track BB width for squeeze detection
            bbWidthSeries[0] = bbIndicator.Upper[0] - bbIndicator.Lower[0];
            ...
            double bbWidthVal = bbWidthSeries[0];
            double bbWidthAvg = SMA(bbWidthSeries, 50)[0];
        ...
        private void DrawDashboard(double todayPnL, int threshold, bool volSurge, double atrVal)
        {
            ...
            Draw.TextFixed(this, "Dashboard", txt, TextPosition.TopRight,
                Brushes.Cyan, new SimpleFont("Courier New", 10),
